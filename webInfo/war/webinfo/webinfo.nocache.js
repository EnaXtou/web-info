...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "webinfo" because\n';
  ...
  $wnd.__gwt_activeModules['webinfo'] = {
    'moduleName' : 'webinfo',
    'bindings' : function() {
      return {};
    }
 ...
 * "/webinfo.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['webinfo'].superdevmode = true;

  var expectedSuffix = '/webinfo.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + webinfo + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:webinfo';
  var devModeSessionKey = '__gwtDevModeSession:webinfo';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/webinfo/webinfo.nocache.js';
  ...
  $wnd.__gwt_activeModules['webinfo'].canRedirect = true;
  $wnd.__gwt_activeModules['webinfo'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/webinfo?user.agent=' + ua + '&_callback=' + callback;
